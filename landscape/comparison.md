...
| OpenAI AgentKit | Platform | Builder, ChatKit, connectors and evals for agent products | End-to-end agent product development | Product bundle may hide architectural tradeoffs | [source](../sources/openai-agentkit.md) |
| OpenAI Agent Builder | Visual builder | Visual canvas for agent workflows | Designing, testing and versioning agent workflows | Visual abstraction may not fit complex code-first systems | [source](../sources/openai-agent-builder.md) |
...
| A2A | Protocol | Agent-to-agent communication and interoperability | Cross-framework or cross-organization agent coordination | Adoption and trust model are still key questions | [source](../sources/a2a-protocol.md) |
...
| Claude Code | Coding agent | Agentic coding system that reads, edits and tests codebases | Production coding-agent patterns | Vendor-specific; evaluate against independent benchmarks | [source](../sources/claude-code.md) |
...
| Generative Agents | Research paper | Memory, reflection and planning in simulated agents | Studying persistent behavior and memory architecture | Simulation differs from tool-use production systems | [source](../sources/generative-agents-paper.md) |
