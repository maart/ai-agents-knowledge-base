...
Этот раздел собирает базовые концептуальные заметки об AI agents. Его лучше читать после [быстрого входа](../../study-guide.md) и перед [Landscape](../../landscape/README.md).
