...
Качество модели — только часть вопроса. Агентские системы требуют инфраструктуры: [SDK](../01-glossary.md#sdk) и [orchestration](../01-glossary.md#orchestration), протоколы подключения инструментов, sandbox execution, observability, [evals](concepts/evals.md), управление правами и recovery для долгих задач.

Поэтому вокруг AI agents быстро растет отдельный слой: [SDK](../01-glossary.md#sdk) и [orchestration](../01-glossary.md#orchestration), [MCP](concepts/protocols-and-interoperability.md), [A2A](concepts/protocols-and-interoperability.md), browser/computer use, [visual agent builders](../01-glossary.md#visual-builders) и [agent platforms](../01-glossary.md#agent-platforms), evaluation platforms и product-specific agents.
...
- [Agent platforms](../01-glossary.md#agent-platforms): visual builders, connector registries, embedded chat and product evals.
